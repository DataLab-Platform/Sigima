...
def _label_location(
    ...
    if isinstance(annotation, PointAnnotation):
        return annotation.x, annotation.y, "x", "y"
    ...
    if isinstance(annotation, (CircleAnnotation, EllipseAnnotation)):
        return annotation.cx, annotation.cy, "x", "y"
